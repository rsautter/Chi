...
def get_exoDataResults():
	return pd.read_csv(r'https://raw.githubusercontent.com/rsautter/Chi/main/results/zExo.csv')

def get_redsDataResults():
	return pd.read_csv(r'https://raw.githubusercontent.com/rsautter/Chi/main/results/zRed.csv')
	
def get_LorenzDataResults():
	return pd.read_csv(r'https://raw.githubusercontent.com/rsautter/Chi/main/results/zLorenz.csv')
